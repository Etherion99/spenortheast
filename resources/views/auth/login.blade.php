        ...
        <div class="col-md-8">
            <div class="form">
                <div class="form-header">
                    <p class="title color-white">Iniciar Sesión</p>
                </div>
                <div class="form-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4 row">
                                ...
                                <div class="col-lg-8 col-md-12 px-0 text-center">
                                    @if (Route::has('password.request'))
                                        <a class="btn btn-link font-weight-bold color-main" href="{{ route('password.request') }}">¿Olvidaste tu contraseña?</a>
                                    @endif
                                </div>                                
                            </div>
                        </div>
